...
public class PileViewTest extends ActivityInstrumentationTestCase2<PileView> {

	private PileView tableView;

	public PileViewTest(){
		super(PileView.class);
	}
...
//	}
	...
	public void testInspectPile(){
		...
		solo.clickOnView(solo.getView(R.id.menu_item_flip));
	}
}
